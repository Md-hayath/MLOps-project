...
model_name = "my_model"#-->IT Bring latest version of register Model form MlFlow
...
model_version = get_latest_model_version(model_name)#---Only Latest version is comming
